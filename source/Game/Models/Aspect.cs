...
public class Aspect {
	...
	public static readonly Color Chartreuse = new Color(0.5f, 1, 0);
	public static readonly Color SpringGreen = new Color(0, 1, 0.5f);
	public static readonly Color Azure = new Color(0, 0.5f, 1);
	public static readonly Color Violet = new Color(0.5f, 0, 1);
	public static readonly Color Rose = new Color(1, 0, 0.5f);
