...
public partial class RoasterUi : KitchenProcessBaseUi {
	...
	public override bool IsUnlocked() {
		return Game.Instance.IsUnlocked(Feature.Roaster);
	}
}
